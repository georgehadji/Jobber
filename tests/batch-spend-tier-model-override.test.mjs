/**
 * batch-spend-tier-model-override.test.mjs — split out of a too-slow-for-one-file batch cluster extracted
 ...
 * and tests/README.md).
 *
 * An explicit --model flag must win over spend_tier-derived routing.
 */
...
console.log('\n14. Batch spend_tier model routing (--model override)');
