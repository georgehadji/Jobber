/**
 * batch-spend-tier-invalid-value.test.mjs — split out of a too-slow-for-one-file batch cluster extracted
 ...
 * and tests/README.md).
 *
 * An invalid/unrecognized spend_tier value must fall back to standard.
 */
...
console.log('\n14. Batch spend_tier model routing (invalid value)');
