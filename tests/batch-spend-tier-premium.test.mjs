/**
 * batch-spend-tier-premium.test.mjs — split out of a too-slow-for-one-file batch cluster extracted
 ...
 * and tests/README.md).
 *
 * Premium spend_tier must resolve to claude-opus-5.
 */
...
console.log('\n14. Batch spend_tier model routing (premium)');
