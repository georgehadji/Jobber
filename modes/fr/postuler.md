...
5. **Jobber proof point** : inclure dans "Informations complementaires" si un tel champ existe
...
3. Suggerer l'etape suivante : `/jobber contacto` pour du LinkedIn outreach vers le hiring manager
