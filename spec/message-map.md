...
| 8 | "Why does this cost anything at all? The CLI says the seeker never pays." | `/rights`, rewritten. "You never pay" is retired (brief §1, founder 2026-09-07). The surviving claim is narrower: the seeker pays, and nobody else does — no employer, recruiter or advertiser. **Conditional on brief §1's outstanding confirmation that this is true.** |
...
5. **Is the "nobody but the seeker pays" claim true — no employer, recruiter or advertiser
   revenue, now or planned?** (brief §1) — objection 8. Blocks `/rights`.
