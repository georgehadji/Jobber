#!/usr/bin/env node
/**
 * openai-tailor.mjs — OpenAI-compatible CV Tailoring for Jobber
 *
...
if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
  console.log(`
╔══════════════════════════════════════════════════════════════════╗
║      Jobber — OpenAI-compatible CV Tailoring (Headless)      ║
╚══════════════════════════════════════════════════════════════════╝
  ...
  OPTIONS
    ...
    --model <id>     Model id            (env ${PROVIDERS.openai.modelEnv}, default ${PROVIDERS.openai.defaultTailorModel})
...
let jdPath     = '';
let reportPath = '';
let modelName  = defaultModelFor('openai', { tailor: true }); // tailoring needs a smarter default than eval
...
// Build system prompt
// ---------------------------------------------------------------------------
const systemPrompt = `You are Jobber, an AI-powered CV tailoring engine.
